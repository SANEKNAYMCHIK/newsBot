...
# Описание
Система для автоматического сбора, обработки и персонализированной доставки новостного контента через Telegram-бота и веб-интерфейс. Пользователи могут настраивать источники новостей, категории интересов и частоту получения уведомлений. Система обеспечивает модерацию контента и предотвращение информационной перегрузки.
# Предметная область
